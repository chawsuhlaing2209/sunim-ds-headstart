...
> **Example — this is another repo's answer, not yours.**
> Written for `sunim-ds-starter`, the repo this headstart was cut from, on
> 2026-08-21. Every name, date, count and verdict in it is a fact about *that*
> project. Read it for the shape and the reasoning; write your own in
> [`governance/operating-model.md`](../operating-model.md). Nothing here is checked by anything, and
> nothing here should be copied into your file unchanged.
